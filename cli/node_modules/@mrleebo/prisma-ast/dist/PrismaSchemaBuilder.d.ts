...
type BuilderValue = string | number | boolean | null | schema.Func | schema.RelationArray | schema.ObjectValue | BuilderValue[] | BuilderValueObject;
...
export declare class ConcretePrismaSchemaBuilder {
    ...
    private getSubject;
    private getParent;
    blockAttribute(name: string, args?: string | BuilderValue[] | Record<string, BuilderValue>, params?: Record<string, BuilderValue>): this;
    attribute<T extends schema.Field>(name: string, args?: Arg[] | Record<string, BuilderValue>): this;
    private mapArg;
    private toValue;
